...
function setupTimeout2(nTimeoutMilliseconds, nWarningTimeoutMilliseconds)
{
 ...
 timeoutID = window.setTimeout('displayTimeoutMsg2()', nTimeoutMilliseconds); var bTopFMode = (typeof top.isFModeLayout != "undefined") ? top.isFModeLayout() : false;   if (isFModeLayout() || bTopFMode) 
 ...
 var bTopFMode = (typeof top.isFModeLayout != "undefined") ? top.isFModeLayout() : false;   if (!bReset && window != top && bTopFMode) { 
...
function psConfirmSW(saveOKEvent, saveCancelEvent, pWin) {
 ...
 var bTopFMode = (typeof top.isFModeLayout != "undefined") ? top.isFModeLayout() : false;   if (!isFModeLayout() && !bTopFMode) { 
 if (typeof isNewSaveWarn !== "undefined" && isNewSaveWarn) {
...
function pingServer(url) {
 var bTopFMode = (typeof top.isFModeLayout != "undefined") ? top.isFModeLayout() : false;   if (!bTopFMode) return;  if (typeof top.workers == "undefined" || workers.length == 0) return; var pingUrl = getUrlHost(url) + "/psc/" + trimWindowsNumber0(getPSHome(url)) + '/?cmd=ping'; top.doGrouplet(pingUrl);}
