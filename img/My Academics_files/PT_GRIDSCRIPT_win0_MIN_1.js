...
function invokegridactionmenu(event)
{
 ...
 {
 gridActionMenu.style.left = positionObj.x +"px";  gridActionMenu.style.top = positionObj.y + 34 + "px"; gridActionMenu.style.visibility = 'visible'; gridActionMenu.className = "showGridactionMenuSection"; }
...
function hideGridActionMenu()
{
 ...
 {
 var gridMenu = iframe_doc.getElementsByClassName("showGridactionMenuSection"); if(gridMenu && gridMenu[0])
 {
 gridMenu[0].style.visibility = 'hidden'; gridMenu[0].className = "hideGridactionMenuSection"; }
 }
